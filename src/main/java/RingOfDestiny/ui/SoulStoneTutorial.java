...
public class SoulStoneTutorial extends FtueTip {
    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString(RingOfDestiny.makeID("SoulStoneTutorial"));
    ...
    public SoulStoneTutorial() {
        this.screen = Color.valueOf("1c262a00");
        this.scrollTimer = 0.0F;
        this.currentSlot = 0;
        this.img1 = ImageMaster.loadImage("RingOfDestiny/img/ui/tip/soulstone/t1.png");
        this.img2 = ImageMaster.loadImage("RingOfDestiny/img/ui/tip/soulstone/t2.png");
        this.img3 = ImageMaster.loadImage("RingOfDestiny/img/ui/tip/soulstone/t3.png");
        this.img4 = ImageMaster.loadImage("RingOfDestiny/img/ui/tip/soulstone/t4.png");
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderSmartText(sb, FontHelper.panelNameFont, msg4, this.x + this.x4 + 400.0F * Settings.scale, Settings.HEIGHT / 2.0F -
                FontHelper.getSmartHeight(FontHelper.panelNameFont, msg4, 700.0F * Settings.scale, 40.0F * Settings.scale) / 2.0F + offsetY, 700.0F * Settings.scale, 40.0F * Settings.scale, Settings.CREAM_COLOR);
