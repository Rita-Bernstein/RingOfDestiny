...
public class DevilGripAction extends AbstractGameAction {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(RingOfDestiny.makeID("DevilGripAction"));
    ...
    public DevilGripAction(AbstractCreature source, int amount) {
        this.dupeAmount = 1;
