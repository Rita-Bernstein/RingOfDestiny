...
import RingOfDestiny.monster.IdeologyCorridor.ThePien;
...
public class IdeologyCorridorScene extends AbstractScene {
    ...
    public IdeologyCorridorScene() {
        super("RingOfDestiny/img/scene/scene.atlas");
        this.bg = this.atlas.findRegion("bg_1_0");
    ...
    public void nextRoom(AbstractRoom room) {
        ...
        if (room.monsters != null) {
            for (AbstractMonster mo : room.monsters.monsters) {
                ...
                if (mo instanceof ThePien) {
                    this.bg = this.atlas.findRegion("bg_1_boss_2");
                }
            }
        }
