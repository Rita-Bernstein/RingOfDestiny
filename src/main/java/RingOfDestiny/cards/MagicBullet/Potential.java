...
public class Potential extends AbstractRingCard {
    public static final String ID = RingOfDestiny.makeID("Potential");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String IMG = RingOfDestiny.assetPath("img/cards/MagicBullet/13.png");
