...
public class InnerFocus extends AbstractRingCard {
    public static final String ID = RingOfDestiny.makeID("InnerFocus");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String IMG = RingOfDestiny.assetPath("img/cards/MagicBullet/25.png");
