...
public class Underhand extends AbstractRingCard {
    public static final String ID = RingOfDestiny.makeID("Underhand");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String IMG = RingOfDestiny.assetPath("img/cards/MagicBullet/58.png");
