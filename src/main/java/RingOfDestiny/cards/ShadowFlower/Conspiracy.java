...
public class Conspiracy extends AbstractRingCard {
    public static final String ID = RingOfDestiny.makeID("Conspiracy");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String IMG = RingOfDestiny.assetPath("img/cards/ShadowFlower/34.png");
