...
public class Kaiser2Effect extends AbstractGameEffect {
    private float x;
    ...
    private int gifFrame = 8;
    private float Frameduration = 32.0f;
    private String  id = "Kaiser2";
    private boolean  soundPlayed  = false;
    private float  tanX = 0.0f;
    private float  tanY = 0.0f;


    public Kaiser2Effect(float fixX,float fixY,float thisX,float thisY) {
