...
public class Repuuken0Effect extends AbstractGameEffect {
    private float x;
    ...
    private int imageHeight = 87;
    private float gifScale = 3.5f;
    private int gifFrame = 15;
    private float Frameduration = 64.0f;
    private String  id = "Repuuken0";
    private boolean  soundPlayed  = false;


    public Repuuken0Effect(float fixX,float fixY) {
        ...
        this.x = fixX ;//.WIDTH * 0.5F - img.packedWidth / 2.0F +Settings.WIDTH * fixX;
    ...
    public void update() {
        ...
        if(!soundPlayed){
            //CardCrawlGame.sound.playA(RingOfDestiny.makeID("HitHeavy")+MathUtils.random(2), MathUtils.random(0.0F, -0.15F));
            soundPlayed = true;
        }
              }
