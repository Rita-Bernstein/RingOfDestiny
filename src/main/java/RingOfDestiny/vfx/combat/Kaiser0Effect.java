...
public class Kaiser0Effect extends AbstractGameEffect {
    private float x;
    ...
    private int imageHeight = 158;
    private float gifScale = 3.5f;
    private int gifFrame = 6;
    private float Frameduration = 32.0f;
    private String  id = "Kaiser0";
    private boolean  soundPlayed  = false;
    private float  tanX = 0.0f;
    private float  tanY = 0.0f;


    public Kaiser0Effect(float fixX,float fixY,float thisX,float thisY) {
