...
public class SlashEffect extends AbstractGameEffect {
    private float x;
    ...
    public SlashEffect(float fixX,float fixY) {
    ...
    public void update() {
        ...
        if(!soundPlayed){
            CardCrawlGame.sound.playA(RingOfDestiny.makeID("Slash"), MathUtils.random(0.0F, -0.15F));
            soundPlayed = true;
        }
              }
