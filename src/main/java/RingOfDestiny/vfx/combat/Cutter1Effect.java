...
public class Cutter1Effect extends AbstractGameEffect {
    private float x;
    ...
    private int imageWidth = 74;
    private int imageHeight = 239;
    private float gifScale = 4.0f;
    private int gifFrame = 16;
    private float Frameduration = 32.0f;
    private String  id = "Cutter1";
    private boolean  soundPlayed  = false;


    public Cutter1Effect(float fixX,float fixY) {
