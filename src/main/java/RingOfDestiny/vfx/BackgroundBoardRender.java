...
public class BackgroundBoardRender extends AbstractGameEffect {
    ...
    private static TextureAtlas.AtlasRegion img2 = null;
    private float y1, y2;
    ...
    public BackgroundBoardRender(float X1, float Y1, float X2, float Y2, float Scale) {
        ...
        img2 = new TextureAtlas.AtlasRegion(new Texture(RingOfDestiny.assetPath("img/stages/UI/Bottom.png")), 0, 0, 1280, 144);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(img2, this.x2, this.y2, img.packedWidth / 2.0F, img.packedHeight / 2.0F, img.packedWidth, img.packedHeight, this.scale, this.scale, 0.0f);
    }
