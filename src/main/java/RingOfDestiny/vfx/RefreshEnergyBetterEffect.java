...
public class RefreshEnergyBetterEffect extends AbstractGameEffect {
    ...
    public RefreshEnergyBetterEffect(float x,float y,float scale) {
        this.scale = scale * Settings.scale / 1.2F;
    ...
    public RefreshEnergyBetterEffect(float x,float y) {
        this(x,y,1.0f);
    }
