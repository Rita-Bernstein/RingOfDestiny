...
public class MeowSister extends CustomMonster {
    public static final String ID = RingOfDestiny.makeID("MeowSister");
    ...
    public MeowSister(float x, float y) {
        ...
        loadAnimation("RingOfDestiny/monsters/KnowledgeHall/MeowSister/MeowSister.atlas", "RingOfDestiny/monsters/KnowledgeHall/MeowSister/MeowSister.json", 2.6F);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case 2:
                ...
                addToBot(new GainBlockAction(this, 7));
                break;
        }
    ...
    protected void getMove(int num) {
        switch (moveCount % 3) {
            case 0:
                ...
                break;
            case 1:
                setMove((byte) 1, Intent.ATTACK_DEBUFF, this.damage.get(0).base, 3, true);
            case 2:
                setMove((byte) 2, Intent.ATTACK_DEFEND, this.damage.get(0).base, 3, true);
                break;
        }
