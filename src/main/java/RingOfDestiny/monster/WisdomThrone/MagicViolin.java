...
public class MagicViolin extends CustomMonster {
    public static final String ID = RingOfDestiny.makeID("MagicViolin");
    ...
    public MagicViolin(float x,float y) {
        super(NAME, ID, 88, 0.0F, -15.0F, 280.0F, 360.0F, null, x, y);
        ...
        loadAnimation("RingOfDestiny/monsters/WisdomThrone/MagicViolin/MagicViolin.atlas", "RingOfDestiny/monsters/WisdomThrone/MagicViolin/MagicViolin.json", 2.6F);
...
//        AbstractDungeon.getCurrRoom().playBgmInstantly("fight_elite");
        ...
        addToBot(new ApplyPowerAction(this, this, new RequiemPower(this)));
        addToBot(new ApplyPowerAction(this, this, new WaltzPower(this)));
    }
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case 1:
                ...
                addToBot(new CustomWaitAction(0.5f));
                addToBot(new DamageAction(AbstractDungeon.player, this.damage.get(1), AbstractGameAction.AttackEffect.BLUNT_HEAVY, true));
