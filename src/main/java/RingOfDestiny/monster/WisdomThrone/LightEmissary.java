...
import RingOfDestiny.powers.Monster.WisdomThrone.ReflectionPower;
...
public class LightEmissary extends CustomMonster {
    public static final String ID = RingOfDestiny.makeID("LightEmissary");
    ...
    public LightEmissary() {
        ...
        loadAnimation("RingOfDestiny/monsters/WisdomThrone/LightEmissary/LightEmissary.atlas", "RingOfDestiny/monsters/WisdomThrone/LightEmissary/LightEmissary.json", 3.0F);
    ...
    public void usePreBattleAction() {
        addToBot(new ApplyPowerAction(this, this, new ReflectionPower(this)));
