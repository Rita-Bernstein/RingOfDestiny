...
public class CantPlayNonSkillPower extends AbstractRingPower {
    public static final String POWER_ID = RingOfDestiny.makeID("CantPlayNonSkillPower");
    ...
    public CantPlayNonSkillPower(AbstractCreature owner, int amount) {
    ...
    public void atEndOfTurn(boolean isPlayer) {
        addToBot(new ReducePowerAction(this.owner, this.owner, CantPlayNonSkillPower.POWER_ID, 1));
    }
}
